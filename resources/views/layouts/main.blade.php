        ...
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle text-black" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i>
                        {{Auth::user()->name}}
                    </a>
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-white " href="{{ route('welcome.index') }}">
                            ...
                            <a class="nav-link collapsed text-white" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon "><i class="fa-solid fa-bag-shopping text-white"></i></div>
                                Productos
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    @can(['administrador'])
                                    <a class="nav-link text-white " href="{{ route('productos.create') }}">Crear nuevo</a>
                                    @endcan
                                    <a class="nav-link text-white" href="{{ route('productos.index') }}">Listar</a>
                                </nav>
                            </div>
                            @can(['administrador'])
                            <a class="nav-link collapsed text-white" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><i class="fa-regular fa-user text-white"></i></div>
                                Usuarios
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            @endcan
                            <div class="collapse" id="collapsePages" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    @can(['administrador'])
                                    <a class="nav-link text-white" href="{{ route('usuarios.create') }}">Crear nuevo</a>
                                    <a class="nav-link text-white" href="{{ route('usuarios.index') }}">Listar</a>
                                    @endcan
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link text-white" href="{{ route('pedidos.create') }}">Crear nuevo</a>
                                    <a class="nav-link text-white" href="{{ route('pedidos.index') }}">Listar</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <h1 class="mt-3 text-center">@yield('titulo')</h1> 
