...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" id="masa1" href="#">Masa Express</a>
        <!-- Sidebar Toggle-->
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li>
                            <a class="dropdown-item text-black" href=""
                                onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="fa-solid fa-right-to-bracket pe-2"></i>Cerrar sesion
                            </a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    @can(['administrador'])
                                    <a class="nav-link text-white" href="{{ route('productos.create') }}"><i class="fa-sharp fa-solid fa-plus pe-2"></i>Crear nuevo</a>
                                    @endcan
                                    <a class="nav-link text-white" href="{{ route('productos.index') }}"><i class="fa-sharp fa-solid fa-list pe-2"></i>Listar</a>
                                </nav>
                            </div>
                            @can(['administrador'])
                            <a class="nav-link collapsed text-white" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><i class="fa-sharp fa-solid fa-users text-white"></i></div>
                                Usuarios
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            @endcan
