...
@section('content')
    ...
    <form action="{{ route('pedidos.store') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
        ...
        <div class="row g-2">
            ...
            <div class="col-md">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="apellidoCliente" name="apellidoCliente" placeholder="apellidoCliente" required>
                    <label for="apellidoCliente">Apellido: </label>
                </div>
            </div>
        </div>
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="direccionCliente" name="direccionCliente" placeholder="direccionCliente" required>
            <label for="direccionCliente">Dirección: </label>
        </div>
        <div class="row g-2">
            <div class="col-md">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="correoCliente" name="correoCliente" placeholder="correoCliente" required>
